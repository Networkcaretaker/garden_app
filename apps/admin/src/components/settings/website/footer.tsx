        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => onContentChange('footer', 'title', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => onContentChange('footer', 'text', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-teal-500 focus:border-teal-500"
          ...
          <div className="md:col-span-2 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => onContentChange('footer', 'showCTA', !settings.content?.footer?.showCTA)}
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-4 mt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={settings.content?.footer?.cta?.buttonVariant || 'none'}
