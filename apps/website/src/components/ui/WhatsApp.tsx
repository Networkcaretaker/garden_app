...
interface WhatsAppButtonProps {
  /** The target phone number (no + or spaces, e.g., '34600123456') */
  phoneNumber?: string;
  /** Pre-filled message text */
  message?: string;
  /** Button label text (not used in floating variant) */
  label?: string;
...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ 
  ...
  return (
    ...
    >
      <WhatsAppIcon className={variant === 'floating' ? "w-8 h-8" : "w-5 h-5 mr-2"} />
